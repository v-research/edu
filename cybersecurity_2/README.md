...
### Second Scenario
- Install OpenVAS from [HERE]([https://greenbone.github.io/docs/latest/22.4/kali/index.html](https://greenbone.github.io/docs/latest/22.4/container/index.html)). Install the docker version unless you are using Kali.
- NESSUS
