...
**Table of Content**
* [Intro](#intro)
* [A Small Step for a Man](#a-small-step-for-a-man)
...
This process is rather trivial and is mentioned here as it is going to be the underlying methodology for the whole course.

Further, you may have heard of black- or white-box testing when you either have no access to the source code (black-box) or when you do have access to it (white-box).
We are going to see both examples in this course.
...
## Summary and Reviews and Experiments
