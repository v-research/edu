                    ...
                    if (innerchild.attrib[schema + 'type'] == "uml:Node"):
                        ...
                        if (innerchild.attrib['informationSource'] in flows):
                            if('name' in innerchild.attrib.keys()):
                                flows[innerchild.attrib['informationSource']].append({'target':innerchild.attrib['informationTarget'], 'information':innerchild.attrib['name']})
                            else:
                                flows[innerchild.attrib['informationSource']].append({'target': innerchild.attrib['informationTarget'],'information': None})
                        else:
                            if ('name' in innerchild.attrib.keys()):
                                flows[innerchild.attrib['informationSource']]=[{'target':innerchild.attrib['informationTarget'], 'information':innerchild.attrib['name']}]
                            else:
                                flows[innerchild.attrib['informationSource']]=[{'target': innerchild.attrib['informationTarget'],'information': None}]
    #print(dict_of_block)
    #print(flows)
...
if __name__ == "__main__":
    ...
    f = open(os.path.join(path, spec + "_struct.txt"), "w+")
